...
public class UI_ForceStrikeAimer_C015 : UI_ForceStrikeAimerMeele
{ 
    protected AttackManagerRanged _attackManagerSpecial;
    ...
    private void OnDisable()
    {
        ...
        //_attackManagerSpecial.ForceStrikeRelease(currentFSLV);
    }
    ...
    public override void SetActorController(ActorControllerMeeleWithFS ac)
    {
        this.ac = ac;
        _attackManagerSpecial = ac.GetComponent<AttackManagerRanged>();
        //ac.OnAttackInterrupt += ResetCurrentFSLvl;
    }
