...
public class Projectile_C003_3 : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        {
            var projectile = transform.GetChild(i).GetComponent<Projectile_C003_2>();
