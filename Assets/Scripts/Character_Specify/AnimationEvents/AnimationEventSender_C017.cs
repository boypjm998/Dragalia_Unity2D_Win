...
public class AnimationEventSender_C017 : AnimationEventSenderNew
{
    protected ActorControllerRangedWithFS _actorControllerSP;
    protected AttackManager_C017 _attackManagerSP;

    protected override void Start()
    {
        base.Start();
        _actorControllerSP = ActorController as ActorControllerRangedWithFS;
        _attackManagerSP = _attackManager as AttackManager_C017;
    }
    ...
    protected override void AttackAction(int actionID)
    {
        switch (actionID)
        {
            case 2011:
                ...
                break;
            case 2012:
                _attackManagerSP.Skill1_Attack();
                break;
            
            case 2021:
                _attackManagerSP.Skill2_Muzzle();
                break;
            
            case 2031:
                _attackManagerSP.Skill3_Muzzle();
                break;
            case 2032:
                _attackManagerSP.Skill3_Shield();
                break;
